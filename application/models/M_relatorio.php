    ...
    public function buscarReservasPorData($dataMapa){
        try {
            $sql = "SELECT 
                    ...
                    AND m.estatus = ''
                    ORDER BY FIELD(h.descricao, 'MANHA', 'TARDE', 'NOITE'), m.sala"; //$dataMapa = data corrigida e entre aspas
            ...
            //Corrigir a concatenação da mensagem de erro
            $dados = array(
                'codigo' => 00,
                'msg' => 'ATENÇÃO: O seguinte erro aconteceu -> ' . $e->getMessage()
            );
        }
        //Envia o array $dados com a informações tratadas acima pela estrutura de decisão if
        return $dados;
    }
}
