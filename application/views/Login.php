...
<head>
    ...
    <link rel="stylesheet" href="../../DSI2/assets/css/stylePassword.css">
...
<body>
    <div class="container" >
        ...
        <div class="text-center">
            <img src="../../DSI2/assets/img/logo_fatecSR.png" alt="Logo da Empresa" style="max-width: 200px; 
                      margin-bottom: 20px;">
        </div>
...
<script src="../../DSI2/assets/js/jquery-3.6.0.min.js"></script>
<script src="../../DSI2/assets/js/bootstrap.min.js"></script>
<script src="../../DSI2/assets/js/sweetalert2.all.min.js"></script>
