...
<head>
    ...
    <title>Home - Sitema Mapa de Sala</title>
    <link rel="icon" href="../../DSI2/assets/img/icone_fatecSR.ico" type="image/x-icon">
</head>
        ...
        <section class="secao4" id="sobre">
            <div class="secao4-div">
                ...
                <a href="../funcoes/abreProfessor" class="secao4-div-card card">
                    <img decoding="async" src="../assets/img/professores.png" alt="imagem do card 2 professores">
                    <h3>Docente</h3>
                ...
                <a href="../funcoes/abreTurma" class="secao4-div-card card">
                    <img decoding="async" src="../assets/img/turma.png" alt="imagem do card 3 turma">
                    <h3>Turma</h3>
                ...
                <a href="../funcoes/abrePeriodo" class="secao4-div-card card">
                    <img decoding="async" src="../assets/img/periodo.png" alt="imagem do card 4 período">
                    <h3>Período</h3>
                    <p>Clique para Cadastrar, Editar, Consultar ou Excluir um novo período.
                    </p>
                </a>

                <!-- Card 5 -->
                <a href="../funcoes/abreMapa" class="secao4-div-card card">
                    <img decoding="async" src="../assets/img/mapeamento.png" alt="imagem do card 5 mapeamento">
                    <h3>Reservas</h3>
                ...
                <a href="../funcoes/abreRelatorio" class="secao4-div-card card">
                    ...
                    <img decoding="async" src="../assets/img/relatorio.png" alt="imagem do card 6 relatório">
                    <h3>Relatório</h3>
                ...
                <a href="../Funcoes/encerraSistema" class="secao4-div-card card">
                    <img decoding="async" src="../assets/img/sair.png" alt="imagem do card 7 sair">
